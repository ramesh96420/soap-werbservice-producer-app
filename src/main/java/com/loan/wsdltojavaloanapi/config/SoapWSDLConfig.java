package com.loan.wsdltojavaloanapi.config;
...
public class SoapWSDLConfig {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
		...
		defaultWsdl11Definition.setTargetNamespace("http://www.example.org/spring/soap/api/loaneligibility");
